...
public:
	...
	virtual void        create_beam_ent_point(int  start_entity, const vector3d* start, int end_entity, const vector3d* end,
	...
	virtual void        create_beam_points(vector3d& start, vector3d& end, int model_index, int halo_index, float halo_scale,
		float life, float width, float end_width, float fade_length, float amplitude,
		float brightness, float speed, int start_frame,
		float framerate, float r, float g, float b);
	...
	virtual void        create_beam_ring_point(const vector3d& center, float start_radius, float end_radius, int model_index, int halo_index, float halo_scale,
		float life, float width, float end_width, float fade_length, float amplitude,
		float brightness, float speed, int start_frame,
		float framerate, float r, float g, float b, int flags);
	virtual beam_t* create_beam_ring_point(beam_info_t& beam_info);

	virtual void        create_beam_circle_points(int type, vector3d& start, vector3d& end,
